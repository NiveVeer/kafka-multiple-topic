...
public class master_nf extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3682933970798266543L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"master_nf\",\"namespace\":\"avro.consumer.schema\",\"doc\":\"Sample schema\",\"fields\":[{\"name\":\"disposition\",\"type\":[\"null\",\"string\"]},{\"name\":\"contract_status\",\"type\":[\"null\",\"string\"]},{\"name\":\"insurence_letter\",\"type\":[\"null\",\"int\"]},{\"name\":\"booking_date\",\"type\":[\"null\",{\"type\":\"long\",\"logicalType\":\"date\"}]}]}");
   ...
   */
  public static avro.consumer.schema.master_nf.Builder newBuilder() {
    return new avro.consumer.schema.master_nf.Builder();
  }
   ...
   * @return A new master_nf RecordBuilder
   */
  public static avro.consumer.schema.master_nf.Builder newBuilder(avro.consumer.schema.master_nf.Builder other) {
    if (other == null) {
      return new avro.consumer.schema.master_nf.Builder();
    } else {
      return new avro.consumer.schema.master_nf.Builder(other);
    }
  }
   ...
   * @return A new master_nf RecordBuilder
   */
  public static avro.consumer.schema.master_nf.Builder newBuilder(avro.consumer.schema.master_nf other) {
    if (other == null) {
      return new avro.consumer.schema.master_nf.Builder();
    } else {
      return new avro.consumer.schema.master_nf.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<master_nf>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(avro.consumer.schema.master_nf.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(avro.consumer.schema.master_nf other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.disposition)) {
        this.disposition = data().deepCopy(fields()[0].schema(), other.disposition);
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.consumer.schema.master_nf.Builder setDisposition(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.consumer.schema.master_nf.Builder clearDisposition() {
      disposition = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.consumer.schema.master_nf.Builder setContractStatus(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.consumer.schema.master_nf.Builder clearContractStatus() {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.consumer.schema.master_nf.Builder setInsurenceLetter(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.consumer.schema.master_nf.Builder clearInsurenceLetter() {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.consumer.schema.master_nf.Builder setBookingDate(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.consumer.schema.master_nf.Builder clearBookingDate() {
      booking_date = null;
